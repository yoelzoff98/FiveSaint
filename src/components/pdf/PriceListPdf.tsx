      ...
      */}
      <div className="page-break-after p-0 h-[297mm] w-[210mm] mx-auto bg-accent-deep shadow-xl print:shadow-none relative overflow-hidden flex flex-col justify-center items-center">
        ...
        <div className="absolute bottom-0 w-full z-10 pb-16 pt-8 px-12 flex flex-col items-center justify-center">
          <div className="grid grid-cols-2 gap-x-24 gap-y-10 w-fit">

            {/* Contacto 1 - Dirección */}
            <div className="flex items-center gap-5">
              <div className="w-11 h-11 rounded-full border border-white/20 bg-white/5 flex items-center justify-center text-white shrink-0 shadow-sm backdrop-blur-sm">
              ...
              <div className="flex flex-col">
                <span className="font-semibold text-white/50 tracking-[0.2em] uppercase text-[8px] mb-1">Dirección</span>
                <span className="text-[10.5px] font-medium text-white/90 leading-snug">Baradero 1520, B1708 Morón<br />Provincia de Buenos Aires</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col">
                <span className="font-semibold text-white/50 tracking-[0.2em] uppercase text-[8px] mb-1">Sitio Web</span>
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col">
                <span className="font-semibold text-white/50 tracking-[0.2em] uppercase text-[8px] mb-1">Instagram</span>
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col">
                <span className="font-semibold text-white/50 tracking-[0.2em] uppercase text-[8px] mb-1">YouTube</span>
                <span className="text-[11px] font-medium text-white/90">@FiveSaintOk</span>
              </div>
            </div>
          </div>

          <div className="w-full max-w-[80%] border-t border-white/10 pt-8 mt-12 text-center text-white/30 text-[8.5px] uppercase tracking-[0.2em] font-medium">
