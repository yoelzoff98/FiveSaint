...
const parseOfertaDescription = (desc: string) => {
  const hydroMatch = desc.match(/(\d+)\s*jets?\s*de\s*caudal/i);
  const hydroCount = hydroMatch ? hydroMatch[1] : '4';

  const cervicalMatch = desc.match(/(\d+)\s*jets?\s*cervicales/i);
...
// Helper to format dimensions. E.g., "150x70" -> "150 × 70"
const formatMedida = (medida: string) => {
  if (!medida) return '';
  return medida
    .replace(/\s*[xX×]\s*/g, ' × ')
    .trim();
...
const CheckedCircleIcon = ({ size = 14 }: { size?: number }) => (
  <div className="bg-accent-deep text-white rounded-full flex items-center justify-center shrink-0" style={{ width: size, height: size }}>
    ...
    <div ref={ref} className="bg-white w-full print:bg-white text-slate-800 text-sm font-sans">
      ...
      */}
      <div className="page-break-after p-0 h-[297mm] max-h-[297mm] w-[210mm] mx-auto bg-white shadow-xl print:shadow-none relative overflow-hidden flex flex-col font-sans">
        ...
        <div className="px-10 py-5 shrink-0 flex items-center gap-6 border-b border-slate-200 mx-6 mt-3">
          <div className="w-14 h-14 rounded-full bg-accent-deep text-white flex items-center justify-center shrink-0 shadow-md">
        ...
        <div className="flex-grow flex px-10 py-6 gap-10">
          ...
          <div className="w-[42%] flex flex-col gap-6">
            <div className="flex items-center gap-3 border-b border-slate-200 pb-2">
              ...
              <h3 className="text-[15px] font-black text-accent-deep uppercase tracking-wider">INFORMACIÓN GENERAL</h3>
            </div>
          ...
          <div className="w-[55%] flex flex-col pl-4">
            <div className="flex items-center gap-3 border-b border-slate-200 pb-2 mb-4">
              ...
              <h3 className="text-[15px] font-black text-accent-deep uppercase tracking-wider leading-tight">ENCONTRÁ RÁPIDAMENTE<br />LO QUE BUSCÁS</h3>
            </div>

            <div className="flex flex-col flex-grow justify-between pb-2">
              {/* 01 */}
              <div className="flex gap-4 items-center pr-6">
                <div className="w-8 h-8 rounded-full bg-accent-deep text-white flex items-center justify-center font-black text-[13px] shrink-0">01</div>
                <div className="w-10 h-10 shrink-0 text-accent-deep flex items-center justify-center">
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="flex-grow">
                  <h4 className="text-[11px] font-black text-accent-deep uppercase leading-tight">CONFIGURACIONES PREMIUM CONFORT Y CONFORT PLUS</h4>
              ...
              {/* 02 */}
              <div className="flex gap-4 items-center pr-6">
                <div className="w-8 h-8 rounded-full bg-accent-deep text-white flex items-center justify-center font-black text-[13px] shrink-0">02</div>
                <div className="w-10 h-10 shrink-0 text-accent-deep flex items-center justify-center">
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="flex-grow">
                  <h4 className="text-[11px] font-black text-accent-deep uppercase leading-tight">BAÑERAS</h4>
              ...
              {/* 03 */}
              <div className="flex gap-4 items-center pr-6">
                <div className="w-8 h-8 rounded-full bg-accent-deep text-white flex items-center justify-center font-black text-[13px] shrink-0">03</div>
                <div className="w-10 h-10 shrink-0 text-accent-deep flex items-center justify-center">
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="flex-grow">
                  <h4 className="text-[11px] font-black text-accent-deep uppercase leading-tight">EQUIPAMIENTO ADICIONAL</h4>
              ...
              {/* 04 */}
              <div className="flex gap-4 items-center pr-6">
                <div className="w-8 h-8 rounded-full bg-accent-deep text-white flex items-center justify-center font-black text-[13px] shrink-0">04</div>
                <div className="w-10 h-10 shrink-0 text-accent-deep flex items-center justify-center">
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="flex-grow">
                  <h4 className="text-[11px] font-black text-accent-deep uppercase leading-tight">OFERTAS</h4>
              ...
              {/* 05 */}
              <div className="flex gap-4 items-center pr-6">
                <div className="w-8 h-8 rounded-full bg-accent-deep text-white flex items-center justify-center font-black text-[13px] shrink-0">05</div>
                <div className="w-10 h-10 shrink-0 text-accent-deep flex items-center justify-center">
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              {/* 06 */}
              <div className="flex gap-4 items-center pr-6">
                <div className="w-8 h-8 rounded-full bg-accent-deep text-white flex items-center justify-center font-black text-[13px] shrink-0">06</div>
                <div className="w-10 h-10 shrink-0 text-accent-deep flex items-center justify-center">
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                ...
                <div className="flex-grow">
                  <h4 className="text-[11px] font-black text-accent-deep uppercase leading-tight">PLATOS DE DUCHA</h4>
              ...
              {/* 07 */}
              <div className="flex gap-4 items-center pr-6">
                <div className="w-8 h-8 rounded-full bg-accent-deep text-white flex items-center justify-center font-black text-[13px] shrink-0">07</div>
                <div className="w-10 h-10 shrink-0 text-accent-deep flex items-center justify-center">
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div key={`premium-showcase-page-${pageIndex}`} className="page-break-after p-0 h-[297mm] max-h-[297mm] w-[210mm] mx-auto bg-white shadow-xl print:shadow-none relative overflow-hidden flex flex-col justify-between p-8">
                ...
                {pageIndex === 1 && (
                  <div className="shrink-0 mb-3.5 bg-slate-50 border border-slate-200 rounded-xl p-3.5 shadow-sm">
                    <div className="flex items-center justify-between border-b border-slate-200 pb-1.5 mb-2">
                      <h2 className="text-[11.5px] font-black text-accent-deep uppercase tracking-wider">Especificaciones de Equipamientos</h2>
                    </div>
                        ...
                        {rowChunk.map((group) => (
                          <div key={group.name} className="flex flex-col bg-white rounded-xl border border-slate-200 p-2 shadow-sm hover:shadow-md transition-shadow h-full">
                            <div className="mb-1 shrink-0">
                              <span className="text-[9.5px] font-bold text-slate-400 uppercase tracking-widest block leading-none">Configuración Premium</span>
                              <h2 className="text-sm font-black text-accent-deep uppercase tracking-wide leading-tight mt-0.5">{group.name}</h2>
                            </div>
                            ...
                            <div className={`${pageIndex === 1 ? 'h-[160px]' : 'h-[96px]'} w-full border border-slate-200 bg-slate-50 rounded-lg overflow-hidden flex items-center justify-center relative mb-2 shrink-0`}>
                              {group.imagePath ? (
                                ...
                                <div className="flex flex-col items-center justify-center p-2 text-slate-300 h-full w-full">
                                  ...
                                  <span className="text-[9.5px] font-mono uppercase tracking-wider">Sin Foto</span>
                                </div>
                              )}
                            </div>
                              ...
                              <table className="w-full text-left border-collapse text-[9.5px]">
                                <thead>
                                  <tr className="border-b border-slate-200 text-slate-500 font-bold">
                                    ...
                                    <th className="py-0.5 text-center bg-[#006d9c] text-white rounded-t-md text-[9.5px] font-bold w-[31%]">CONFORT</th>
                                    <th className="py-0.5 text-center bg-[#d0a65c] text-white rounded-t-md text-[9.5px] font-bold w-[31%]">CONFORT PLUS</th>
                                  </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-100">
              ...
              <div className="mt-3 border border-slate-200 bg-slate-50 rounded-xl p-2 flex justify-between gap-4 text-left shadow-sm shrink-0">
                ...
                <div className="flex items-center gap-2 w-1/3">
                  <div className="bg-white p-1 rounded-lg border border-slate-200 shadow-sm text-accent-deep shrink-0">
                    <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                  </div>
                  <div>
                    <h4 className="text-[9.5px] font-black text-accent-deep uppercase tracking-wide leading-tight">Calidad y respaldo</h4>
                    <p className="text-[9.5px] text-slate-500 font-medium leading-none mt-0.5">Productos diseñados para durar.</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 w-1/3 border-l border-slate-200 pl-3">
                  ...
                  <div>
                    <h4 className="text-[9.5px] font-black text-accent-deep uppercase tracking-wide leading-tight">Garantía Five Saint</h4>
                    <p className="text-[9.5px] text-slate-500 font-medium leading-none mt-0.5">5 años en Acrílico y 1 año en Bomba.</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 w-1/3 border-l border-slate-200 pl-3">
                  ...
                  <div>
                    <h4 className="text-[9.5px] font-black text-accent-deep uppercase tracking-wide leading-tight">Practicidad y confort</h4>
                  </div>
                </div>
              </div>
                  ...
                  <table className="w-full text-left border-collapse text-[10px]">
                    <thead>
                      <tr className="bg-slate-50 text-slate-700 border-b border-slate-200">
                        ...
                        <th className="py-1 px-2 font-bold uppercase tracking-wider text-[9.5px] border-r border-slate-200 text-center w-[20%]">Casco</th>
                        ...
                        <th className="py-1 px-2 font-bold uppercase tracking-wider text-[9.5px] text-center w-[20%] text-accent-deep">8 Jets</th>
                      </tr>
                    </thead>
                    <tbody>
                      {group.items.map((item, idx) => (
                        <tr key={idx} className="border-b border-slate-100 last:border-0 hover:bg-slate-50 transition-colors">
                          <td className="py-1 px-2 font-bold text-slate-700 text-center font-mono text-[11px] border-r border-slate-200">
                            {group.name === "Martina" ? (
                              item.name.includes("con frente") ? "Con frente (180 × 120)" : "Sin frente (180 × 120)"
                            ) : (
                              formatMedida(item.medidas)
                            )}
                          </td>
      ...
      {Array.from({ length: Math.ceil(ofertasData.length / 3) }).map((_, pageIndex) => {
        ...
        return (
          <div key={`ofertas-page-${pageIndex}`} className="page-break-after p-0 h-[297mm] max-h-[297mm] w-[210mm] mx-auto bg-white shadow-xl print:shadow-none relative overflow-hidden flex flex-col justify-between p-8">
                    ...
                    <div className="w-[52%] flex flex-col h-[250px] justify-between py-0.5">
                      ...
                      <div className="flex justify-between items-center shrink-0">
                        <div className="flex items-center gap-2.5">
                          <h3 className="text-lg font-black text-accent-deep uppercase tracking-wide leading-none">{oferta.name}</h3>
                          <span className="bg-[#e6f2fa] text-accent-deep font-black text-[9px] px-2 py-0.5 rounded uppercase tracking-wider font-mono">
                            {formatMedida(oferta.medidas)}
                          </span>
                        </div>
                      ...
                      <div className="mt-1 shrink-0">
                        <span className="text-[10px] font-black text-accent-deep uppercase tracking-wider block">EQUIPAMIENTO</span>
                      </div>
                        ...
                        <table className="w-full border-collapse text-[10px] text-slate-700 leading-normal">
                          <tbody>
                            <tr className="border-b border-slate-100">
                              <td className="py-[2px] text-left font-bold">
                                <div className="flex items-center gap-1.5">
                                  <HydroJetsIcon className="w-3.5 h-3.5 text-accent-deep" />
                            ...
                            <tr className="border-b border-slate-100">
                              <td className="py-[2px] text-left font-bold">
                                <div className="flex items-center gap-1.5">
                                  <CervicalIcon className="w-3.5 h-3.5 text-accent-deep" />
                            ...
                            <tr className="border-b border-slate-100">
                              <td className="py-[2px] text-left font-bold">
                                <div className="flex items-center gap-1.5">
                                  <VistasIcon className="w-3.5 h-3.5 text-accent-deep" />
                                  <span>Vistas</span>
                                </div>
                              </td>
                            ...
                            <tr className="border-b border-slate-100">
                              <td className="py-[2px] text-left font-bold">
                                <div className="flex items-center gap-1.5">
                                  <SuccionIcon className="w-3.5 h-3.5 text-accent-deep" />
                                  <span>Succión</span>
                                </div>
                              </td>
            ...
            {/* Footer info Ofertas */}
            {renderFooter(
              <p className="mt-0.5 font-bold text-slate-700">Las bañeras de OFERTA se les puede agregar equipamiento <strong className="text-slate-700 font-bold">sin variar la cantidad de jets.</strong></p>
            )}
          </div>
        );
      })}
      ...
      */}
      {Array.from({ length: 2 }).map((_, pageIndex) => {
        ...
        return (
          <div key={`platos-page-${pageIndex}`} className="page-break-after p-0 h-[297mm] max-h-[297mm] w-[210mm] mx-auto bg-white shadow-xl print:shadow-none relative overflow-hidden flex flex-col">
            {/* Banner Superior Premium */}
            <div className="relative w-full h-24 bg-accent-deep overflow-hidden shrink-0">
              <div className="absolute inset-0 opacity-10 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-white to-transparent"></div>
              <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-accent-gold opacity-20 rounded-full blur-3xl"></div>
                    ...
                    {columnasDuchaData.map((columna, idx) => (
                      <div key={idx} className="flex flex-col items-center w-[23%] bg-slate-50 border border-slate-200 rounded-xl p-2.5 shadow-sm relative">
                        ...
                        <div className="w-full flex flex-col items-center text-center">
                          ...
                          <p className="text-[9.5px] text-slate-400 font-bold uppercase tracking-wider mb-2 leading-none">
                            {columna.description}
                          </p>
            ...
            {renderFooter(undefined, "px-16 pb-8")}
          </div>
        );
      })}
      ...
      <div className="page-break-after p-0 h-[297mm] max-h-[297mm] w-[210mm] mx-auto bg-white shadow-xl print:shadow-none relative overflow-hidden flex flex-col">
        ...
        <div className="flex px-10 pt-12 gap-10">
          ...
          <div className="w-[55%] flex flex-col gap-10">
            {duchaEscocesaData.models.map((model, idx) => (
              <div key={idx} className="flex flex-col">
                <h3 className="text-xl font-black text-accent-deep mb-4 uppercase tracking-wide">
                  {model.name}
                </h3>
        ...
        <div className="flex px-10 gap-10 mb-8">
          ...
          <div className="w-[55%] flex flex-col justify-center">
            ...
            <p className="text-[14.5px] text-slate-700 font-medium leading-relaxed mb-6 pr-10">
            ...
            <div className="bg-white border border-slate-300 shadow-sm p-4 text-center rounded-lg inline-block self-start">
              <span className="text-[14.5px] font-bold text-slate-700">{vaporData.contact}</span>
            </div>
          </div>
        </div>

        {renderFooter(undefined, "px-10 pb-8 mx-10")}
      </div>
        ...
        <div className="relative z-10 w-full flex flex-col items-center gap-12 mt-auto">
          <div className="flex flex-row justify-center items-start gap-12 w-full max-w-4xl px-8">
            ...
            <div className="flex flex-col items-center text-center gap-3 w-48">
              ...
              <div className="flex flex-col items-center">
                <span className="font-bold text-white tracking-[0.2em] uppercase text-[10px] mb-1.5">Instagram</span>
                <span className="text-[13px] font-bold text-white">@Five Saint</span>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center gap-3 w-48">
              ...
              <div className="flex flex-col items-center">
                <span className="font-bold text-white tracking-[0.2em] uppercase text-[10px] mb-1.5">YouTube</span>
                <span className="text-[13px] font-bold text-white">@FiveSaintOk</span>
              </div>
            </div>
          </div>

          <div className="w-full max-w-[80%] border-t border-white/20 pt-6 mt-12 text-center text-white/40 text-[9.5px] uppercase tracking-[0.2em] font-bold">
