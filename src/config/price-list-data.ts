...
export const equipamientosData: Equipamiento[] = [
  ...
  { codigo: "FSE124A", nombre: "Comando Digital Simple", descripcion: "Encendido de bomba con control de nivel. Incluye timer de seguridad (15 min.)", precio: "$ 614 000" },
  { codigo: "FSE124B", nombre: "Comando Digital Doble", descripcion: "Encendido de bomba con control de nivel y encendido de turbo soplador con variador de vel.", precio: "$ 684 000" },
  { codigo: "FSE124C", nombre: "Comando Digital Full", descripcion: "Encendido de bomba, turbo soplador, accesorios, tiempo programable y sensor de temp.", precio: "$ 729 000" },
  ...
  { codigo: "FSE104", nombre: "Desborde y Desagüe simple Plástico", descripcion: "", precio: "$ 83 000" },
  ...
  { codigo: "FSE120CQ", nombre: "Grifería llenado F/C", descripcion: "2 llaves laterales 3/4 F/C y llenado interno", precio: "$ 1 139 000" },
  { codigo: "FSE120AQ", nombre: "Grifería llenado F/C (Cascada)", descripcion: "2 llaves 3/4 laterales 3/4 con pico cascada", precio: "$ 1 383 000" },
  { codigo: "FSE123", nombre: "Tablero de seguridad", descripcion: "Caja con disyuntor y térmica", precio: "$ 263 000" },
  { codigo: "FSE118", nombre: "Bastidor (Simple)", descripcion: "Estructura metálica autoportante, incluye piso ref.", precio: "$ 629 000" },
  { codigo: "FSE118D", nombre: "Bastidor (Doble)", descripcion: "Estructura metálica autoportante para bañeras dobles", precio: "$ 829 000" },
...
export const platosDuchaData: PlatosCategory[] = [
  ...
  {
    title: "Curvos",
    image: "/images/platos-curvos.png",
    desagueCode: "FSE131",
    desaguePrice: "$ 28 000",
    items: [
  ...
  {
    title: "Rectangulares",
    image: "/images/platos-rectangulares.png",
    desagueCode: "FSE131",
    desaguePrice: "$ 28 000",
    items: [
...
export const duchaEscocesaData = {
  ...
  images: {
    jet: "/images/ducha-jet.png",
    head: "/images/ducha-head.png",
    full: "/images/ducha-full.png"
  },
  models: [
    {
