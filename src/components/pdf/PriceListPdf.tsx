    ...
    <div ref={ref} className="bg-white w-full print:bg-white text-slate-800 text-sm font-sans">
          ...
          return (
            <div key={`premium-showcase-page-${pageIndex}`} className="page-break-after p-0 h-[297mm] max-h-[297mm] w-[210mm] mx-auto bg-white shadow-xl print:shadow-none relative overflow-hidden flex flex-col justify-between p-8">
                        ...
                        {rowChunk.map((group) => (
                          <div key={group.name} className="flex flex-col bg-white rounded-xl border border-slate-200 p-2 shadow-sm hover:shadow-md transition-shadow h-full">
                            <div className="mb-1 shrink-0">
                              <span className="text-[7px] font-bold text-slate-400 uppercase tracking-widest block leading-none">Configuración Premium</span>
              ...
              <div className="flex justify-between items-center shrink-0 pt-2 border-t border-slate-100 mt-2">
                <p className="text-[11.5px] font-semibold text-slate-700">Los precios publicados corresponden a la versión en color blanco.</p>
      ...
      */}
      <div className="page-break-after p-0 h-[297mm] w-[210mm] mx-auto bg-accent-deep shadow-xl print:shadow-none relative overflow-hidden flex flex-col justify-center items-center">
        ...
        {/* Zócalo de Contacto */}
        <div className="absolute bottom-0 w-full z-10 pb-16 pt-8 px-12 flex flex-col items-center justify-center">
          <div className="grid grid-cols-2 gap-x-32 gap-y-12 w-full max-w-4xl px-8">

            {/* Contacto 1 - Dirección */}
            <div className="flex flex-col items-center text-center gap-3">
              <div className="w-12 h-12 rounded-full border border-white/25 bg-white/10 flex items-center justify-center text-white shrink-0 shadow-sm backdrop-blur-md">
                <svg className="w-6 h-6 opacity-90" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
              </div>
              <div className="flex flex-col">
                <span className="font-semibold text-white/60 tracking-[0.25em] uppercase text-[9px] mb-1.5">Dirección</span>
                <span className="text-[12px] font-medium text-white/95 leading-relaxed">Baradero 1520, B1708 Morón<br />Provincia de Buenos Aires</span>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-semibold text-white/60 tracking-[0.25em] uppercase text-[9px] mb-1.5">Sitio Web</span>
                <span className="text-[12.5px] font-medium text-white/95">www.fivesaint.com</span>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-semibold text-white/60 tracking-[0.25em] uppercase text-[9px] mb-1.5">Instagram</span>
                <span className="text-[12.5px] font-medium text-white/95">@Five Saint</span>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <div className="flex flex-col">
                <span className="font-semibold text-white/60 tracking-[0.25em] uppercase text-[9px] mb-1.5">YouTube</span>
                <span className="text-[12.5px] font-medium text-white/95">@FiveSaintOk</span>
              </div>
            </div>
          </div>

          <div className="w-full max-w-[80%] border-t border-white/10 pt-8 mt-16 text-center text-white/40 text-[9px] uppercase tracking-[0.25em] font-medium">
